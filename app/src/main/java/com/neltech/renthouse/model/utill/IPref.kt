...
import com.neltech.renthouse.BuildConfig
import com.neltech.renthouse.view.base.BaseLifecycleObserver
import dagger.hilt.android.qualifiers.ApplicationContext
import javax.inject.Inject

interface IPref {
    fun put(key: String = "IMAGE", value: Any)
    fun str(key: String = "IMAGE", default: String = ""): String
    fun long(key: String = "IMAGE", default: Long = -1): Long
    fun float(key: String = "IMAGE", default: Float = -1f): Float
    fun int(key: String = "IMAGE", default: Int = -1): Int
    fun bool(key: String = "IMAGE", default: Boolean = false): Boolean
    fun clear()
}

class PrefImpl @Inject constructor(@ApplicationContext private val context: Context) : IPref {
    private val pref: SharedPreferences =
        context.getSharedPreferences("${BuildConfig.APPLICATION_ID}_pref", Context.MODE_PRIVATE)
